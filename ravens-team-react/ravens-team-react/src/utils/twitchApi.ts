...
export const getTeamsForBroadcaster= (broadcasterId: string, config?: AxiosRequestConfig<TeamInfoResponse>): Promise<TeamInfoResponse> => {
    return axios.get<TeamInfoResponse>(`/teams/channel?broadcaster_id=${broadcasterId}`, {...config});
}
